...
dat <- read.csv("Raw Data/Example_detection_data.csv", header=T)
eff <- read.csv("Raw Data/Example_deployment_data.csv", header=T)
sta <- read.csv("Raw Data/Example_station_data.csv", header=T)
...
1. A data frame of "independent detections" at the `r independent` minute threshold you specified at the start: 
  ...
  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent.csv")`"

2/3: A 'site x species' matrix of the number of independent detections and species counts accross the full study period:

  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_total_observations.csv")`"

  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_total_counts.csv")`"
...
4/5: A 'site_month x species' matrix of the number of independent detections and species counts accross for each month in the study period:
  ...
  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Monthly_total_observations.csv")`"

  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Monthly_total_counts.csv")`"
...
6/7: A 'site_week x species' matrix of the number of independent detections and species counts accross for each week in the study period:
  ...
  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Weekly_total_observations.csv")`"

  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Weekly_total_counts.csv")`"
...
8/9: A 'site_day x species' matrix of the number of independent detections and species counts accross for each day a station was active in the study period:
  ...
  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Daily_total_observations.csv")`"

  - "`r  paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Daily_total_counts.csv")`"
...
write.csv(total.obs, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_total_observations.csv"), row.names = F) 

write.csv(total.count, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_total_counts.csv"), row.names = F) 
...
write.csv(mon.obs, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_Monthly_observations.csv"), row.names = F) 

write.csv(mon.count, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_Monthly_counts.csv"), row.names = F) 
...
write.csv(week.obs, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_weekly_observations.csv"), row.names = F) 

write.csv(week.count, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_weekly_counts.csv"), row.names = F) 
...
write.csv(day.obs, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_daily_observations.csv"), row.names = F) 

write.csv(day.count, paste0("Output data/",dat$Project.ID[1], "_",independent ,"min_Independent_daily_counts.csv"), row.names = F) 
