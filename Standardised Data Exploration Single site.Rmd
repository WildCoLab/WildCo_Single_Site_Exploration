...
as.Date(ymd_hms("2019-07-04 0:00", truncated=3))
ymd(ymd_hms("2019-07-04 5", truncated=3))
strptime(as.Date(ymd_hms("2019-07-04", truncated=3)), "%Y-%m-%d", tz=tz)
...
This script outputs 7 useful dataframes for future processing:
