...
Check that the code is outputting sensible total/monthly/weekly dataframes! 
...
Note for weekly data we use year-week where week is the since january 1st. This preserved the temporal structure of weeks (rather than having a miscellaneous counter). 
...
the code is working properly the total observations/counts should be the same at each temporal scale (total/monthly/weekly)
